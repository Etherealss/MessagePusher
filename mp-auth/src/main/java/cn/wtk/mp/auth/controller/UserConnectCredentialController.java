...
import cn.wtk.mp.auth.application.UserConnectCredentialAppService;
...
public class UserConnectCredentialController {
    ...
    private final UserConnectCredentialAppService userConnectCredentialAppService;
    ...
    public ConnectorCredential createCredential(@PathVariable Long connectorId) {
        ...
        return userConnectCredentialAppService.create(appId, connectorId);
    }
    ...
    public ConnectorCredential verify(@PathVariable Long connectorId,
        ...
        Long appId = ServerSecurityContextHolder.require().getServerId();
        return userConnectCredentialAppService.verifyAndGet(appId, connectorId, token);
    }
}
